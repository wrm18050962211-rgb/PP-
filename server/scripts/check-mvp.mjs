...
const checks = [
  ...
  ['domain-delivery-prep', ['scripts/check-domain-delivery-prep.mjs']],
  ...
  ['media-expiry-job', ['scripts/check-media-expiry-job.mjs']],
  ...
  ['postgres-media-writes', ['scripts/check-postgres-media-writes.mjs']],
  ['postgres-media-route', ['scripts/check-postgres-media-route.mjs']],
  ...
  ['postgres-content-route', ['scripts/check-postgres-content-route.mjs']],
  ...
  ['postgres-phone-verification-writes', ['scripts/check-postgres-phone-verification-writes.mjs']],
