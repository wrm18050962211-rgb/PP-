...
const activityAliasKeywords: Record<string, string[]> = {
  日常出片: ['日常', '生活照', '出片', '朋友圈', '小红书', '探店', '餐厅', '咖啡', '城市街拍', '网红餐厅拍照', '街拍'],
  旅行拍照: ['旅行', '跟拍', '游客照', '景点', '路线', '陪逛', '景区', '地标', '城市旅行', '旅行跟拍', '景点游客照'],
  纪念日: ['纪念', '生日', '毕业', '周年', '节日', '约会', '领证', '情侣', '节日纪念', '情侣/婚纱'],
  多人合照: ['多人', '合照', '合影', '朋友', '闺蜜', '情侣', '家庭', '亲子', '宠物', '聚会', '情侣/婚纱', '亲子/宠物'],
