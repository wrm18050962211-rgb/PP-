...
const activityAliasKeywords: Record<string, string[]> = {
  日常社交: ['日常', '生活照', '朋友圈', '小红书', '街拍', '探店', 'citywalk'],
  记录当下: ['写真', '生活照', '日常感', '自然', '抓拍', '松弛', '记录'],
  旅行拍照: ['旅行', '跟拍', '景点', '游客照', '路线', 'citywalk', '城市'],
  纪念日: ['纪念', '生日', '周年', '节日', '毕业', '礼物'],
  重要的人: ['情侣', '朋友', '闺蜜', '家人', '合影', '亲子', '宠物'],
  形象照片: ['形象照', '头像', '通勤', '商务', '职业', '个人形象', '商业'],
